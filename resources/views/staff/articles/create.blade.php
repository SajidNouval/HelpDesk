                    ...
                    <div class="p-6">
                        ...
                        <form method="POST" action="{{ route('staff.articles.store') }}" class="space-y-6">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="is_published" id="is_published" value="1" {{ old('is_published', true) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
