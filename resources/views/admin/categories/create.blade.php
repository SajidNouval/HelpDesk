    ...
    <div class="bg-gray-100 py-6 border-b">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Buat kategori baru untuk Knowledge Base.
            </p>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-9">
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Form Tambah Kategori</h2>
                    <p class="text-sm text-gray-500">Isi detail kategori baru di bawah ini.</p>
                </div>
