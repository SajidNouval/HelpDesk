        ...
        <div class="grid grid-cols-12 gap-8">
            ...
            <div class="col-span-12 md:col-span-9">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="p-6">
                        <form id="staff-form" action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6" data-confirm="Apakah Anda yakin ingin menyimpan perubahan staf?">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="role" name="role" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
